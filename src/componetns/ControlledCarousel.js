  ...
  return (
    <Carousel activeIndex={index} onSelect={handleSelect} className="bg-dark">
      ...
      <Carousel.Item className="p-5 text-center hero-slider">
        <div className="d-flex justify-content-center align-items-center h-100">
          <Container className=" text-white w-75">
            <h2 className="h1 mb-3 font-weight-light">Мир стоит на пороге<br/> <span style={{ color: "#D04F45" }}>новой технологической волны</span></h2>
            <h5 className="mb-3 font-weight-light" style={{ color: "silver" }}>Пандемия ускорила изменение отраслей, не готовых к
                  ...
                  наиболее высокая инновационная культура и производительность труда.
                </h5>
